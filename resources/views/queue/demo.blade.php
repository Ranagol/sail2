    ...
    <div class="w-full space-y-6">
        ...
        <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
            <div class="bg-gradient-to-r from-violet-500 via-purple-500 to-indigo-600 px-6 py-6 text-white">
                ...
                <h1 class="mt-2 text-2xl font-bold">Laravel Jobs &amp; Queues</h1>
                <p class="mt-2 text-sm text-purple-100">
                    Dispatch email jobs to the Redis queue and watch them pile up — then run a
                    worker to process them. All the moving parts are explained below.
                </p>
            </div>
